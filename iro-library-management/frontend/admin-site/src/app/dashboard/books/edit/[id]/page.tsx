...
export default function EditBookPage({ params }: EditBookPageProps) {
  ...
  const { data: bookResponse, isLoading, error } = useBookQuery(params.id);
      ...
      setFormData({
        ...
        acquisitionInfo: book.acquisitionInfo
          ? {
              ...
              acquisitionDate: book.acquisitionInfo.acquisitionDate
                ? new Date(book.acquisitionInfo.acquisitionDate)
                    .toISOString()
                    .split("T")[0]
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if ((formData.categories?.length || 0) === 0) {
      ...
      <div className="p-6 max-w-4xl mx-auto">
        <div className="bg-red-50 dark:bg-red-900 border border-red-200 dark:border-red-700 rounded-lg p-4">
          ...
          <Link
            ...
            className="mt-3 inline-block px-4 py-2 bg-red-600 text-white rounded-md hover:bg-red-700"
          >
            Back to Books
          </Link>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                type="text"
                value={bookResponse?.data?.book?.bookId || ""}
                readOnly
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select
                value={formData.acquisitionInfo?.source || "purchase"}
                onChange={(e) =>
                  handleNestedChange(
                    "acquisitionInfo",
                    "source",
